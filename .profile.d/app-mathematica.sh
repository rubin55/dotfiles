...
CFG_ALIAS="mathematica"
CFG_EXEC_UNIX="/opt/wolfram/mathematica13/Scripts/mathematica"
CFG_EXEC_MACOS="/Applications/Mathematica.app/Contents/bin/mathematica"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Mathematica/mathematica.exe"
