...
SCRIPTS_EXTRAS="/opt/jetbrains/scripts $HOME/Syncthing/Source/RAAF/session $HOME/Syncthing/Source/ICTU/various/gitlab-getenv/bin $HOME/Source/gitlab-getenv/bin $HOME/Syncthing/Source/ICTU/various/helmster/bin $HOME/Source/helmster/bin"
