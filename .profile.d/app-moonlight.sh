...
CFG_ALIAS="moonlight"
CFG_EXEC_UNIX="/opt/moonlight/ml4/moonlight"
CFG_EXEC_MACOS="/Applications/Moonlight.app/Contents/MacOS/moonlight"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Moonlight/moonlight.exe"
