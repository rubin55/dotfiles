...
CFG_ALIAS="groovy"
CFG_EXEC_UNIX="/opt/groovy/groovy24/bin/groovy"
CFG_EXEC_MACOS="$HOME/Applications/Groovy/groovy24/bin/groovy"
CFG_EXEC_WINDOWS="/mnt/c/Program files/Groovy/groovy24/bin/groovy.bat"
