...
CFG_ALIAS="gradle"
CFG_EXEC_UNIX="/opt/gradle/gradle46/bin/gradle"
CFG_EXEC_MACOS="$HOME/Applications/Gradle/gradle46/bin/gradle"
CFG_EXEC_WINDOWS="/mnt/c/Program files/Gradle/gradle46/bin/gradle.bat"
