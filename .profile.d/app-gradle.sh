...
CFG_ALIAS="gradle"
CFG_EXEC_UNIX="/opt/gradle/gradle7/bin/gradle"
CFG_EXEC_MACOS="$HOME/Applications/Gradle/gradle7/bin/gradle"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Gradle/gradle7/bin/gradle.bat"
