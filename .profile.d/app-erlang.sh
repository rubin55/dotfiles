...
CFG_ALIAS="erlc"
CFG_EXEC_UNIX="/opt/erlang/otp23/bin/erlc"
CFG_EXEC_MACOS="$HOME/Applications/Erlang/otp23/bin/erlc"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Erlang/OTP23/bin/erlc.exe"
