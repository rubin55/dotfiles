...
CFG_ALIAS="sunshine"
CFG_EXEC_UNIX="/opt/sunshine/ss0/bin/sunshine"
CFG_EXEC_MACOS="/Applications/Sunshine.app/Contents/MacOS/sunshine"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Sunshine/sunshine.exe"
