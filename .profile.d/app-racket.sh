...
CFG_ALIAS="racket"
CFG_EXEC_UNIX="/opt/racket/racket8/bin/racket"
CFG_EXEC_MACOS="$HOME/Applications/Racket/racket8/bin/racket"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Racket/racket8/bin/racket.exe"
