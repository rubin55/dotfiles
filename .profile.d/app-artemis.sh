...
CFG_ALIAS="artemis"
CFG_EXEC_UNIX="/opt/activemq/artemis2/bin/artemis"
CFG_EXEC_MACOS="$HOME/Applications/ActiveMQ/artemis2/bin/artemis"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Apache/artemis2/bin/artemis.bat"
