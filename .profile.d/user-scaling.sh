...
if [[ "$platform" == "linux" && ! -z "$(which get-resolution.py 2> /dev/null)" ]]; then
    ...
    declare -A settings=(
     ...
     [2560x1600]="codeMono=24,emacsMono=24,emacsSans=24,vimMono=13,gnomeMono=12,gnomeSans=11,gnomeSerif=11"
     [3840x2160]="codeMono=38,emacsMono=38,emacsSans=38,vimMono=15,gnomeMono=13,gnomeSans=12,gnomeSerif=12"
    )
