...
CFG_ALIAS="kafka-server-start.sh"
CFG_EXEC_UNIX="/opt/kafka/kafka3/bin/kafka-server-start.sh"
CFG_EXEC_MACOS="$HOME/Applications/Kafka/kafka3/bin/kafka-server-start.sh"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Kafka/kafka3/bin/windows/kafka-server-start.bat"
