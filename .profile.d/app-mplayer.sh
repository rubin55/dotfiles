...
CFG_ALIAS="mplayer"
CFG_EXEC_UNIX="/opt/mplayer/mp15/bin/mplayer"
CFG_EXEC_MACOS="$HOME/Applications/MPlayer/mp15/bin/mplayer"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/MPlayer/bin/mplayer.exe"
