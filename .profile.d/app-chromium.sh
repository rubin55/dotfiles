...
CFG_ALIAS="chrome"
CFG_EXEC_UNIX="/opt/chromium/ungoogled/chrome"
CFG_EXEC_MACOS="/Applications/Ungoogled Chromium.app/Contents/macos/bin/chrome"
CFG_EXEC_WINDOWS="/mnt/c/Program Files/Ungoogled Chromium/chrome.exe"
